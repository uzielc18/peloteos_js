                    ...
                    <form onSubmit={store} className="w-full max-w-sm">
                        <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                            ...
                            <div className="md:flex md:items-center mb-6">
                                ...
                                <Combobox value={socio_id} onChange={setSocioId}>
                                <div className="relative mt-1">
                                  <div className="relative w-full cursor-default overflow-hidden rounded-lg bg-white text-left shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-teal-300 sm:text-sm">
                                    <Combobox.Input
                                      className="w-full border-none py-2 pl-3 pr-10 text-sm leading-5 text-gray-900 focus:ring-0"
                                      displayValue={(person) => person.razon_social}
                                      onChange={(event) => getSocios(event.target.value)}
                                    />
                                              ...
                                              <>
                                                <span
                                                  className={`block truncate ${
                                                    socio_id ? 'font-medium' : 'font-normal'
                                                  }`}
                                                >
                                                  {person.razon_social}
                                                </span>
